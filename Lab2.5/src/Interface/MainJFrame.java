...
public class MainJFrame extends javax.swing.JFrame {
   ...
   double defaultMin = 70;
    ...
    private void initComponents() {
        ...
        Max_bp_label = new javax.swing.JLabel();
        jLabel2 = new javax.swing.JLabel();
        Max_bp_field = new javax.swing.JTextField();
        Min_bp_label = new javax.swing.JLabel();
        Min_bp_field = new javax.swing.JTextField();
        ...
        Max_bp_label.setText("Max_bp :");

        Min_bp_label.setText("Min_bp :");
            ...
            .addGroup(controlJpanelLayout.createSequentialGroup()
                .addGroup(controlJpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(controlJpanelLayout.createSequentialGroup()
                        .addGap(24, 24, 24)
                        .addGroup(controlJpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Max_bp_label)
                            .addGroup(controlJpanelLayout.createSequentialGroup()
                                .addGap(81, 81, 81)
                                .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(Min_bp_label)
                            .addGroup(controlJpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(Min_bp_field, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 69, Short.MAX_VALUE)
                                .addComponent(Max_bp_field, javax.swing.GroupLayout.Alignment.LEADING))))
        ...
        controlJpanelLayout.setVerticalGroup(
            ...
            .addGroup(controlJpanelLayout.createSequentialGroup()
                ...
                .addComponent(Max_bp_field, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(12, 12, 12)
                .addComponent(jLabel2)
                .addGap(26, 26, 26)
                .addComponent(Min_bp_label)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(Min_bp_field, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(36, 36, 36)
                .addComponent(abnbtn)
    ...
    private void abnbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_abnbtnActionPerformed
        // TODO add your handling code here:
        VitalSigns vii=new VitalSigns();
        String maxbpString=Max_bp_field.getText();
        double maxbp=maxbpString.equals("")?Double.MAX_VALUE:Double.parseDouble(maxbpString);
         try {
            Double.parseDouble(maxbpString);
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(null, maxbpString + " Please enter a valid number.");
        }
        String minbpString=Min_bp_field.getText();
        double minbp=minbpString.equals("")?Double.MIN_VALUE:Double.parseDouble(minbpString);
         try {
            Double.parseDouble(minbpString);
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(null, minbpString + " Please enter a valid number.");
        }
        vii.setMaxbp(maxbp);
        vii.setMinbp(minbp);
        VitalSignHistory vsh1=new VitalSignHistory();
        ArrayList<VitalSigns>list1=vsh.getAbnormalList(maxbp, minbp);
        vsh1.setVitalSignHistory(list1);
        ViewVitalJPanel viewPanel11=new ViewVitalJPanel(vsh1);
        splitPanel.setRightComponent(viewPanel11);
    ...
    private javax.swing.JTextField Max_bp_field;
    private javax.swing.JLabel Max_bp_label;
    private javax.swing.JTextField Min_bp_field;
    private javax.swing.JLabel Min_bp_label;
